    ...
    >
      ...
      <div className="flex flex-row gap-2 items-center">
        <EditOnGitHub
          ...
          href={`https://github.com/allindiacoderlife/anime-ui/blob/main/apps/www/content/docs/${params.slug ? `${params.slug.join('/')}.mdx` : 'index.mdx'}`}
        />
        <LLMCopyButton markdownUrl={`${page.url}.mdx`} />
        <ViewOptions
          markdownUrl={`${page.url}.mdx`}
          githubUrl={`https://github.com/allindiacoderlife/anime-ui/blob/main/apps/www/content/docs/${page.path}`}
        />
      </div>
...
export async function generateMetadata(props: {
  ...
  return {
    ...
    authors: page.data?.author
      ...
      : {
          name: 'allindiacoderlife',
          url: 'https://github.com/allindiacoderlife',
        },
    openGraph: {
      title: page.data.title,
      description: page.data.description,
      url: 'https://anime-ui.com',
      siteName: 'Anime UI',
      images: image,
      locale: 'en_US',
      type: 'website',
